 ...
 */
export const TeammateStatus = Schema.Literal("idle", "coding", "waiting", "error", "completed");
export type TeammateStatus = typeof TeammateStatus.Type;

/**
 * View mode for the Teams UI.
 */
export const TeamsViewMode = Schema.Literal("split", "center");
...
export const Teammate = Schema.Struct({
  ...
  prStatus: Schema.NullOr(Schema.Literal("open", "merged", "closed")),
  model: Schema.String,
 ...
 */
export const ActivityEntryType = Schema.Literal(
  "started",
  "completed",
  "error",
  "waiting",
...
export const TeammateSpawnedMessage = Schema.Struct({
  channel: Schema.Literal("teams.teammate.spawned"),
  payload: Teammate,
});
...
export const TeammateStatusUpdateMessage = Schema.Struct({
  channel: Schema.Literal("teams.teammate.status"),
