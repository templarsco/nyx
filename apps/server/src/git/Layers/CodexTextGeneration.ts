...
import { CodexModelSelection } from "@nyx/contracts";
...
import { normalizeCodexModelOptionsWithCapabilities } from "@nyx/shared/model";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `nyx-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
