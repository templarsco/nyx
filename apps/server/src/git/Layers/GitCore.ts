...
import { GitCommandError, type GitBranch } from "@nyx/contracts";
import { dedupeRemoteBranchesWithLocalMatches } from "@nyx/shared/git";
...
import { decodeJsonResult } from "@nyx/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `nyx-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
