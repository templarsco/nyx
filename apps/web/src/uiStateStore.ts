...
import { type ProjectId, type ThreadId } from "@nyx/contracts";
import { create } from "zustand";

const PERSISTED_STATE_KEY = "nyx:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "nyx:renderer-state:v8",
  "nyx:renderer-state:v7",
  "nyx:renderer-state:v6",
  "nyx:renderer-state:v5",
  "nyx:renderer-state:v4",
  "nyx:renderer-state:v3",
