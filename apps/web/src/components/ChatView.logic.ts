import { ProjectId, type ModelSelection, type ThreadId, type TurnId } from "@nyx/contracts";
...
export const LAST_INVOKED_SCRIPT_BY_PROJECT_KEY = "nyx:last-invoked-script-by-project";
export const MAX_HIDDEN_MOUNTED_TERMINAL_THREADS = 10;
const WORKTREE_BRANCH_PREFIX = "nyx";
