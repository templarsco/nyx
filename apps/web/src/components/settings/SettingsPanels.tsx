...
import { DEFAULT_UNIFIED_SETTINGS } from "@nyx/contracts/settings";
import { normalizeModelSlug } from "@nyx/shared/model";
...
function getProviderSummary(provider: ServerProvider | undefined) {
  ...
  if (!provider.enabled) {
    return {
      headline: "Disabled",
      detail:
        provider.message ?? "This provider is installed but disabled for new sessions in Nyx.",
    };
  }
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Nyx looks across the app."
          resetAction={
            theme !== "system" ? (
